...
extension MapVC: MKMapViewDelegate {
    ...
    @objc func dropPin(sender: UITapGestureRecognizer) {
        ...
        removePin()
        //Remove spinners (if any) otherwise it will stack w/every pin drop
        removeSpinner()
        //Remove Progress Lbl - Same reason as spinner above
        removeProgressLbl()
        //If Downloading & user places another pin, cancel that session
        cancelAllSessions()
        //Empty the arrays for each new pin and reload collectionView.
        imageUrlArray = []
        imageArray = []
        ...
        //Add Spinner
        addSpinner()
        //Add Progress Label for downloading images
        addProgressLbl()
        ...
        mapView.setRegion(coordinateRegion, animated: true)
        //Retrieve image URLs, remove previous spinner&progressLbl &reload
...
extension MapVC: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        //Called when one of the cells are tapped
